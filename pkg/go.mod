module github.com/devexps/go-bootstrap/pkg

go 1.18

replace github.com/devexps/go-bootstrap/api => ../api

require (
	github.com/devexps/go-bootstrap/api v0.0.0-00010101000000-000000000000
	github.com/devexps/go-micro/config/consul/v2 v2.0.0-20230908050544-6405f2d205af
	github.com/devexps/go-micro/config/etcd/v2 v2.0.0-20230908050544-6405f2d205af
